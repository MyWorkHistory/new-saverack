  ...
  <Teleport to="body">
    <Transition name="modal-backdrop">
      <div
        ...
        aria-modal="true"
        role="dialog"
        aria-labelledby="cau-bulk-edit-modal-title"
      >
        <div
        ...
        <Transition name="modal-panel" appear>
          <div class="crm-vx-modal crm-vx-modal--sm">
            ...
            <header class="crm-vx-modal__head">
              <h2 id="cau-bulk-edit-modal-title" class="crm-vx-modal__title">
                Bulk edit
              </h2>
            ...
            <div class="crm-vx-modal__body pt-0">
              <div class="form-check mb-3">
                <input
                  id="cau-bulk-change-status"
                  v-model="changeStatus"
                  type="checkbox"
                  class="form-check-input"
                />
                <label class="form-check-label fw-medium" for="cau-bulk-change-status">
                  Change status
                </label>
              </div>
              <div v-if="changeStatus">
                <label class="form-label small mb-1 text-secondary" for="cau-bulk-status"
                  >Status</label
                >
                <select id="cau-bulk-status" v-model="status" class="form-select">
