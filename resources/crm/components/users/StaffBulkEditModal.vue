        ...
        <Transition name="modal-panel" appear>
          ...
          >
              ...
              <div class="space-y-5">
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    class="mt-0.5 h-4 w-4 rounded border-gray-300 text-[#206ba4] focus:ring-[#206ba4]"
                  />
                  ...
                  <span class="min-w-0 flex-1">
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                      ...
                      >
                        <input
                          type="checkbox"
                          class="rounded border-gray-300 text-[#206ba4] focus:ring-[#206ba4]"
            ...
            >
              <button
                type="button"
                class="inline-flex min-h-[2.75rem] flex-1 items-center justify-center rounded-xl bg-[#206ba4] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-[#206ba4]/40 disabled:opacity-50 sm:flex-none"
