    ...
    <Transition name="modal-backdrop">
      ...
      >
        ...
        <Transition name="modal-panel" appear>
          <div
            class="relative z-10 flex max-h-[min(90dvh,640px)] w-full max-w-sm flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gray-900"
          >
            <header
              ...
              <div class="space-y-5">
                ...
                >
                  <input
                    ...
                    type="checkbox"
                    class="mt-0.5 h-4 w-4 rounded border-gray-300 text-[#2563eb] focus:ring-[#2563eb]"
                  />
