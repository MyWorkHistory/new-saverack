...
async function loadDashboardSummary() {
  const [dashboardRes, billingRes] = await Promise.all([
  ...
  if (billing && typeof billing === "object") {
    billingSummary.value = {
      open_balance_due_cents: Number(billing.open_balance_due_cents || 0),
      overdue_invoice_count: Number(billing.overdue_invoice_count || 0),
    };
  }
}
      ...
      <div class="row g-4 mb-4">
        ...
        <div class="col-12 col-sm-6 col-xl-4">
          <CrmMetricCard
            ...
            period-label="New active this month"
          />
        </div>
        <div class="col-12 col-sm-6 col-xl-4">
          <CrmMetricCard
            label="Open Balance"
            :value="formatCents(billingSummary.open_balance_due_cents)"
            :change-pct="null"
            :period-label="
              billingSummary.overdue_invoice_count > 0
                ? `${nf.format(billingSummary.overdue_invoice_count)} overdue invoice(s)`
