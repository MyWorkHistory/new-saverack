        ...
        <div class="staff-detail-tab-bar-wrap ms-lg-auto flex-grow-1">
          <div class="staff-detail-tab-bar">
            <button
              ...
              :class="{ 'staff-detail-tab-btn--disabled': pdfDownloading }"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">{{ pdfDownloading ? "Downloading…" : "Download PDF" }}</span>
            </button>
            <button
              v-if="currentStatusKey !== 'void'"
              type="button"
              class="staff-detail-tab-btn"
              :class="{ 'staff-detail-tab-btn--disabled': copyLinkBusy }"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">{{ copyLinkBusy ? "Working…" : "Copy Link" }}</span>
            </button>
            <button
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">Send Invoice</span>
            </button>
            <button
              v-if="payInvoiceVisible"
              type="button"
              class="staff-detail-tab-btn"
              :class="{ 'staff-detail-tab-btn--disabled': !payInvoiceEnabled }"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">Pay Invoice</span>
            </button>
            <button
              v-if="canShowMessagingActions"
              type="button"
              class="staff-detail-tab-btn"
              :class="{ 'staff-detail-tab-btn--disabled': messagingActionsDisabled }"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">Email Invoice</span>
            </button>
            <button
              v-if="canShowMessagingActions"
              type="button"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">Whatsapp</span>
            </button>
            <button
              v-if="invoice && currentStatusKey !== 'paid' && currentStatusKey !== 'void'"
              type="button"
              class="staff-detail-tab-btn"
              :class="{ 'staff-detail-tab-btn--disabled': !canStripeCharge }"
            ...
            >
              ...
              <span class="staff-detail-tab-btn__label">Credit Charge</span>
            </button>
            <div class="staff-detail-tab-bar-actions" data-right-actions>
              <button
                type="button"
                class="staff-detail-tab-btn"
                :class="{ 'staff-detail-tab-btn--active': rightActionsMenuOpen }"
