  ...
  <div class="staff-page staff-page--wide staff-directory-page">
    ...
    >
      <div class="min-w-0 flex-grow-1 text-center text-md-start w-100">
        ...
        <p class="staff-page__intro location-labels-intro mb-0">
          Search, create, and print warehouse location barcodes
        </p>
      </div>
      <div class="d-flex flex-nowrap align-items-center gap-2 justify-content-center justify-content-md-end flex-shrink-0">
        <button
          v-if="canCreate"
          type="button"
          class="btn btn-outline-secondary orders-toolbar-outline-btn d-inline-flex align-items-center gap-2 text-nowrap"
