        ...
        >
            ...
            >
              ...
              <div class="min-w-0 flex-1">
                ...
                >
                  ...
                  <button
                    type="button"
                    class="mt-2 inline-flex items-center gap-1 text-xs font-medium text-[#206ba4] hover:underline"
          ...
          <div class="pt-6">
            ...
            <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                type="button"
                class="mt-2 inline-flex shrink-0 justify-center rounded-xl bg-[#206ba4] px-4 py-2 text-sm font-semibold text-white hover:opacity-95 disabled:opacity-50 sm:mt-0"
