...
const routes = [
  ...
  },
  {
    ...
    component: ClientAccountDetailPage,
    props: (route) => ({
      id: String(route.params.accountId),
      storeConnectionId: String(route.params.connectionId),
    }),
    meta: meta.clientAccountDetail,
  },
  {
  ...
  },
  {
    ...
    name: "shopify-inventory-log-hub",
    component: ShopifyInventoryLogHubPage,
    meta: meta.shopifyInventoryLogHub,
  },
  {
    path: "/admin/shopify/inventory-log/:id",
    name: "shopify-inventory-log",
  ...
  {
    path: "/users/my-account/pricing",
    name: "user-my-account-pricing",
    component: () => import("../pages/user-portal/UserPortalPricingPage.vue"),
    meta: { title: "Save Rack | Pricing", description: "Account fulfillment pricing.", userPortal: true },
  },
  {
    path: "/users/my-account/fulfillment-agreement",
    name: "user-my-account-agreement",
    component: () => import("../pages/user-portal/UserPortalFulfillmentAgreementPage.vue"),
    meta: { title: "Save Rack | Fulfillment Agreement", description: "Account fulfillment agreement.", userPortal: true },
  },
  {
    path: "/users/my-account/shipping-instructions",
    name: "user-my-account-shipping",
    component: () => import("../pages/user-portal/UserPortalShippingInstructionsPage.vue"),
    meta: { title: "Save Rack | Shipping Instructions", description: "Shipping carrier preferences.", userPortal: true },
  },
  { path: "/users/my-account", redirect: "/users/my-account/pricing" },
