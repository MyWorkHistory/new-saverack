...
<head>
    ...
    <title>Your Save Rack Fulfillment account — Save Rack</title>
</head>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:440px;margin:0 auto;">
                ...
                <tr>
                    <td align="center" style="padding:0 8px 26px 8px;font-size:20px;line-height:1.35;font-weight:600;color:#0f0f0f;">
                        Your Save Rack Fulfillment account has been created and we&rsquo;re ready to begin onboarding.
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:0 8px 28px 8px;font-size:15px;line-height:1.5;color:#4b5563;">
                        Please log in to your account and start completing the onboarding steps so we can prepare your fulfillment setup, connect your store, and get your account ready for shipping.
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:0 8px 36px 8px;">
                        <a href="{{ $loginUrl }}" style="display:inline-block;background:#2563eb;color:#ffffff !important;text-decoration:none;padding:16px 40px;border-radius:999px;font-weight:700;font-size:17px;line-height:1;">
                            Login
                        </a>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:0 8px 8px 8px;font-size:15px;line-height:1.5;color:#4b5563;">
                        Account
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding:0 8px 32px 8px;font-size:18px;line-height:1.35;font-weight:700;color:#0f0f0f;">
                        {{ $accountName }}
                    </td>
                </tr>
                <tr>
