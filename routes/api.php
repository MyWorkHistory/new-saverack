...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('invoices/{invoice}/cancel-payment', [InvoiceController::class, 'cancelPayment'])
        ->name('invoices.cancel-payment');
    ...
    Route::prefix('shopify')->group(function () {
        ...
        Route::get('/orders/meta', [ShopifyIntegrationController::class, 'ordersMeta']);
        Route::get('/orders/export', [ShopifyIntegrationController::class, 'ordersExport']);
        ...
        Route::post('/orders', [ShopifyIntegrationController::class, 'ordersStore']);
        ...
        Route::patch('/inventory/{shopifyVariant}/packaging', [ShopifyIntegrationController::class, 'updateVariantPackaging']);
